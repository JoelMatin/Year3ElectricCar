...
//verifie si p1 p2 p3 sont enumeres dans le sens trigonométrique
...
//vérifie s'il y a intersection entre segments p1p2 et p3p4: si le sens d'enumeration (trigo ou anti
// trigo) de p1, p2, p3 n'est pas celui de p1, p2, p4 ou que celui de p1, p3, p4 est different de celui de p2, p3, p4 alors
//pour chaque segment, le deuxième point se trouve de l'autre cote du deuxieme segment donc intersection. Un point
//d'un segment ne peut pas être sur l'autre sinon le sens d'enumeration est le même et il n'y a pas intersection
