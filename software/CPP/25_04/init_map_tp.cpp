...
emetteur  maSource{ point{32, 10},868.3F*(float)pow(10,6), 73.0, 0.1, std::vector<float>(0, 0) , 0};
...
void creerMap(mur MursVert[], mur MursHor[], mur MursObl[]) {
    creerMur(MursVert, point{0, 0}, point{0, 80}, 4.8*epsilon0, 0.018, 0.15, 0);
    creerMur(MursHor, point{ 0, 20 }, point{ 79, 20 }, 4.8*epsilon0, 0.018, 0.15, 0);
    creerMur(MursHor, point{ 0, 80 }, point{ 79, 80 }, 4.8 * epsilon0, 0.018, 0.15, 1);
}
