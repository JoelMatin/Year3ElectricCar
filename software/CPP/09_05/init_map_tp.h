...
const emetteur maSourceTX2{ point{-10, 0.5}, 26 * (float)pow(10, 9), 73, 3.16277 , std::vector<float>(0, 0), };
const emetteur maSourceTX3{ point{-10, 0.5}, 26 * (float)pow(10, 9), 73, 3.16277 , std::vector<float>(0, 0), -0.1}; 
