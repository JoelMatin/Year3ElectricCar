...
int main(void) {
    ...
    std::vector<std::vector<float>> puissancesPoints1 = puissanceMap(mesPointsMap1, maSourceTX3);
    std::vector<std::vector<float>> puissancesPoints2 = puissanceMap(mesPointsMap2, maSourceTX3);   
    ...
    dessinerPuissances(maSourceTX3.coordonnees, puissancesPoints1, puissancesPoints2);
